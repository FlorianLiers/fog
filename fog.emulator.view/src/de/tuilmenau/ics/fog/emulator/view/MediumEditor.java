...
import de.tuilmenau.ics.fog.emulator.EmulatorMedium;


/**
 * Editor for showing and editing the internals of a bus.
 */
public class MediumEditor extends EditorPart
{
	public MediumEditor()
	{
	}
	...
	public void init(IEditorSite site, IEditorInput input) throws PartInitException
	{
		...
		if(inputObject != null) {
			...
			if(inputObject instanceof EmulatorMedium) {
				mBus = (EmulatorMedium) inputObject;
				
				// TODO impl
			} else {
				throw new PartInitException("Invalid input object " +inputObject +" (class=" +inputObject.getClass() +"). " +EmulatorMedium.class +" expected.");
			}
		} else {
	...
	private EmulatorMedium mBus = null;
